"""Pure Python wrapper for the Tin class."""
from .._xmsgrid.triangulate import TrTin


class Tin(object):
    """Class for representing tin geometries."""

    def __init__(self, points=None, triangles=None, **kwargs):
        """Constructor.

        Args:
            points (list): The tin points as x,y,z tuples
            triangles (list): The tin triangles as point index tuples
    ...
    def __eq__(self, other):
        ...
        Args:
            other (Tin): Tin to compare

        Returns:
            bool: True if Tins are equal
        """
    ...
    def __ne__(self, other):
        ...
        Returns:
            bool: True if Tins are not equal
        """
        result = self.__eq__(other)
        return not result

    def __repr__(self):
        """Returns a string representation of the Tin."""
    ...
    def triangles_adjacent_to_points(self, _triangles_adjacent_to_points):
        """Set triangles adjacent to points."""
    ...
    def boundary_polys(self):
        """Exterior boundary and all interior voids as polygons of 0-based point indices.
    ...
    def next_boundary_point(self, point):
        """Get the next point CW from point on the boundary.

        CCW if in an inside hole.
    ...
    def previous_boundary_point(self, point):
        """Get the previous point CCW from point on the boundary.

        CW if in an inside hole.
    ...
    def remove_long_thin_triangles_on_perimeter(self, ratio):
        ...
        Args:
            ratio: The ratio of one edge length compared to the sum of the other two edge lengths.  If the length
                ratio of a triangle is greater then or equal to this given ratio, the triangle is deleted.
