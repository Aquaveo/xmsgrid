...
class TestXmUGridUtilFunctions(unittest.TestCase):
    ...
    def test_xm_write_and_read_ugrid_to_ascii_file(self):
        ...
        np.testing.assert_array_equal(xu3d.get_locations(), xu_read.get_locations())
        np.testing.assert_array_equal(xu3d.get_cellstream(), xu3d.get_cellstream())

    def test_cross(self):
        self.assertEqual(XmUGridUtils.cross((0, 0, 0), (5, 5, 0), (3, 4, 0)), 5)
        self.assertEqual(XmUGridUtils.cross((7, 3, 0), (10, 5, 0), (11, 9, 0)), 10)
        self.assertEqual(XmUGridUtils.cross((4, 5, 0), (3, 8, 0), (6, 2, 0)), -3)
    ...
    def test_do_line_segments_cross(self):
        ...
        point3 = (2, 1, 0)
        point4 = (4, 1, 0)
        self.assertEqual(False, XmUGridUtils.do_line_segments_cross(point1, point2, point3, point4))
        ...
        point3 = (2, 4, 0)
        point4 = (4, 2, 0)
        self.assertEqual(True, XmUGridUtils.do_line_segments_cross(point1, point2, point3, point4))
