...
class TestXmUGridPointFunctions(unittest.TestCase):
    ...
    def test_xmugrid_locations(self):
        import numpy as np
        points = ((0, 0, 0), (20, 0, 0), (0, 20, 0))
        cells = (5, 3, 0, 1, 2)
        xu = XmUGrid(points, cells)
    ...
    def test_xmugrid_locations_numpy(self):
        import numpy as np
        points = np.array(((0, 0, 0), (20, 0, 0), (0, 20, 0)))
        xu = XmUGrid()
        self.assertEqual(0, xu.point_count())  # Should be empty
    ...
    def test_xmugrid_point_location(self):
        points = ((0, 0, 0), (20, 0, 0), (0, 20, 0))
        cells = (5, 3, 0, 1, 2)
        xu = XmUGrid(points, cells)
        p1 = xu.point_location(0)
        p2 = xu.point_location(1)
        p3 = xu.point_location(2)
        p4 = xu.point_location(3)
        self.assertEqual((0, 0, 0), p1)
        self.assertEqual((20, 0, 0), p2)
        self.assertEqual((0, 20, 0), p3)
        self.assertEqual((0, 0, 0), p4)

    def test_xmugrid_point_xy0(self):
    ...
    def test_xmugrid_set_location(self):
        ...
        self.assertEqual((-10, -10, 0), xu.point_location(0))
    ...
    def test_xmugrid_points_locations(self):
        import numpy as np
        points = np.array(((0, 10, 0), (10, 10, 0), (20, 10, 0), (0, 0, 0), (10, 0, 0),
                           (20, 0, 0), (0, -10, 0), (10, -10, 0), (20, -10, 0)))
        cells = np.array((9, 4, 0, 3, 4, 1, 9, 4, 1, 4, 5, 2, 9, 4, 3, 6, 7, 4, 9, 4, 4, 7, 8, 5))
        ...
        points_from_indxs = xu.points_locations(point_indices)
        np.testing.assert_array_equal(expected_points, points_from_indxs)

    def test_xmugrid_extents(self):
        points = ((0, 0, 0), (10, 0, 0), (20, 0, 0), (30, 0, 0), (40, 0, 0),
                  (0, 10, 0), (10, 10, 0), (20, 10, 0), (40, 10, 0), (0, 20, 0),
                  (10, 20, 0), (20, 20, 0), (30, 20, 0), (40, 20, 0))
        cells = (XmUGrid.xmugrid_celltype_enum.XMU_QUAD, 4, 0, 1, 6, 5,
    ...
    def test_point_adjacent_cells(self):
        ...
        self.assertEqual(cell_empty, xu.point_adjacent_cells(-1))
        self.assertEqual(cell_zero, xu.point_adjacent_cells(0))
        self.assertEqual(cell_zero_and_one, xu.point_adjacent_cells(1))
        self.assertEqual(cell_one, xu.point_adjacent_cells(2))
        self.assertEqual(cell_zero, xu.point_adjacent_cells(3))
        self.assertEqual(cell_zero_and_one, xu.point_adjacent_cells(4))
        self.assertEqual(cell_one, xu.point_adjacent_cells(5))
        self.assertEqual(cell_empty, xu.point_adjacent_cells(6))

    def test_points_adjacent_cells(self):
        points = ((0, 10, 0), (10, 10, 0), (20, 10, 0), (0, 0, 0), (10, 0, 0),
                  (20, 0, 0), (0, -10, 0), (10, -10, 0), (20, -10, 0))
        cellstream = (XmUGrid.xmugrid_celltype_enum.XMU_QUAD, 4, 0, 3, 4, 1,
                       XmUGrid.xmugrid_celltype_enum.XMU_QUAD, 4, 1, 4, 5, 2,
        ...
        points = (-1, 0)
        retrieved_cells = xu.points_adjacent_cells(points)
    ...
    def test_cell_points(self):
        ...
        invalid1 = xu.cell_points(-1)
        invalid2 = xu.cell_points(5)
        ...
        for i in range(0, len(expected_cell_points_2d)):
            cell_points = xu2d.cell_points(i)
        ...
        for i in range(0, len(expected_cell_points_3d)):
            cell_points = xu3d.cell_points(i)
    ...
    def test_cell_type(self):
        ...
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_INVALID_CELL_TYPE, xu2d.cell_type(-1))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_INVALID_CELL_TYPE, xu2d.cell_type(6))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_QUAD, xu2d.cell_type(0))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_PIXEL, xu2d.cell_type(1))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_TRIANGLE, xu2d.cell_type(2))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_POLYGON, xu2d.cell_type(3))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_POLY_LINE, xu2d.cell_type(4))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_LINE, xu2d.cell_type(5))

        xu3d = self.get_3d_linear_ugrid()
        self.assertEqual(30, xu3d.point_count())
        self.assertEqual(6, xu3d.cell_count())
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_INVALID_CELL_TYPE, xu3d.cell_type(-1))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_INVALID_CELL_TYPE, xu3d.cell_type(6))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_TETRA, xu3d.cell_type(0))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_VOXEL, xu3d.cell_type(1))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_HEXAHEDRON, xu3d.cell_type(2))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_POLYHEDRON, xu3d.cell_type(3))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_WEDGE, xu3d.cell_type(4))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_PYRAMID, xu3d.cell_type(5))
    ...
    def test_cell_dimension(self):
        xu2d = self.get_2d_linear_ugrid()
        self.assertEqual(2, xu2d.cell_dimension(0))
        self.assertEqual(2, xu2d.cell_dimension(1))
        self.assertEqual(2, xu2d.cell_dimension(2))
        self.assertEqual(2, xu2d.cell_dimension(3))
        self.assertEqual(1, xu2d.cell_dimension(4))
        self.assertEqual(1, xu2d.cell_dimension(5))

        xu3d = self.get_3d_linear_ugrid()
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_INVALID_CELL_TYPE, xu3d.cell_dimension(-1))
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_INVALID_CELL_TYPE, xu3d.cell_dimension(6))
        self.assertEqual(3, xu3d.cell_dimension(0))
        self.assertEqual(3, xu3d.cell_dimension(1))
        self.assertEqual(3, xu3d.cell_dimension(2))
        self.assertEqual(3, xu3d.cell_dimension(3))
        self.assertEqual(3, xu3d.cell_dimension(4))
        self.assertEqual(3, xu3d.cell_dimension(5))
    ...
    def test_cell_functions(self):
        ...
        # Test cell_extents
        extents = ugrid.cell_extents(0)
        expected_extents = [(0.0, 0.0, 0.0), (10.0, 10.0, 0.0)]
        np.testing.assert_array_equal(expected_extents, extents)

        # Test cell_type
        self.assertEqual(XmUGrid.xmugrid_celltype_enum.XMU_QUAD, ugrid.cell_type(0))

        # Test dimension_counts
        expected_dimensions = (0, 0, 4, 0)
        self.assertEqual(expected_dimensions, ugrid.dimension_counts())

        # Test cell_dimension
        self.assertEqual(2, ugrid.cell_dimension(0))

        # Test cell_centroid
        result = ugrid.cell_centroid(0)
        self.assertEqual(True, result[0])
        self.assertEqual((5, 5, 0), result[1])
        result = ugrid.cell_centroid(-1)
    ...
    def test_cell_point_stream(self):
        import numpy as np
        xu = self.get_simple_quad_ugrid()
        ret, cellstream = xu.cell_point_stream(0)
        expected_cellstream = np.array((XmUGrid.xmugrid_celltype_enum.XMU_QUAD, 4, 0, 3, 4, 1))
        np.testing.assert_array_equal(expected_cellstream, cellstream)

    def test_cell_adjacent_cells(self):
        import numpy as np
        xu = self.get_simple_quad_ugrid()

        expected_cells = np.array(())
        retrieved_cells = xu.cell_adjacent_cells(-1)
        np.testing.assert_array_equal(expected_cells, retrieved_cells)
        retrieved_cells = xu.cell_adjacent_cells(0)
        expected_cells = np.array((2, 1, 3))
        np.testing.assert_array_equal(expected_cells, retrieved_cells)
        expected_cells = np.array(())
        retrieved_cells = xu.cell_adjacent_cells(4)
        np.testing.assert_array_equal(expected_cells, retrieved_cells)
        expected_cells = np.array(())
        retrieved_cells = xu.cell_adjacent_cells(5)
        np.testing.assert_array_equal(expected_cells, retrieved_cells)

    def test_cell_edge_count(self):
        xu2d = self.get_2d_linear_ugrid()
        self.assertEqual(-1, xu2d.cell_edge_count(-1))
        self.assertEqual(-1, xu2d.cell_edge_count(6))
        self.assertEqual(4, xu2d.cell_edge_count(0))
        self.assertEqual(4, xu2d.cell_edge_count(1))
        self.assertEqual(3, xu2d.cell_edge_count(2))
        self.assertEqual(6, xu2d.cell_edge_count(3))
        self.assertEqual(2, xu2d.cell_edge_count(4))
        self.assertEqual(1, xu2d.cell_edge_count(5))

        xu3d = self.get_3d_linear_ugrid()
        self.assertEqual(-1, xu3d.cell_edge_count(-1))
        self.assertEqual(-1, xu3d.cell_edge_count(6))
        self.assertEqual(6, xu3d.cell_edge_count(0))
        self.assertEqual(12, xu3d.cell_edge_count(1))
        self.assertEqual(12, xu3d.cell_edge_count(2))
        self.assertEqual(12, xu3d.cell_edge_count(3))
        self.assertEqual(9, xu3d.cell_edge_count(4))
        self.assertEqual(8, xu3d.cell_edge_count(5))
    ...
    def test_cell_edge(self):
        ...
        self.assertEqual(xu2d.cell_edge(0, -1), (0, 0))
        self.assertEqual(xu2d.cell_edge(0, xu2d.cell_edge_count(0)), (0, 0))
        ...
        for i in range(0, xu2d.cell_count()):
            self.assertEqual(len(expected_cell_edges[i]), xu2d.cell_edge_count(i))
            for j in range(0, xu2d.cell_edge_count(i)):
                self.assertEqual(xu2d.cell_edge(i, j), expected_cell_edges[i][j])
        ...
        for i in range(0, xu2d.cell_count()):
            self.assertEqual(len(expected_cell_edges[i]), xu2d.cell_edge_count(i))
            for j in range(0, xu2d.cell_edge_count(i)):
                self.assertEqual(expected_cell_edges[i][j], xu2d.cell_edge(i, j))
        ...
        for i in range(0, xu3d.cell_count()):
            self.assertEqual(len(expected_cell_edges[i]), xu3d.cell_edge_count(i))
            for j in range(0, xu3d.cell_edge_count(i)):
                self.assertEqual(xu3d.cell_edge(i, j), expected_cell_edges[i][j])

    def test_adjacent_cell_functions(self):
        xuquad = self.get_simple_quad_ugrid()
        expected_cells = [(), (2,), (1,), ()]
        expected_2d_cells = [-1, 2, 1, -1]
        for edge_idx in range(0, xuquad.cell_edge_count(0)):
            self.assertEqual(expected_cells[edge_idx], xuquad.cell_edge_adjacent_cells(0, edge_idx))
            self.assertEqual(expected_2d_cells[edge_idx], xuquad.cell2d_edge_adjacent_cell(0, edge_idx))

        expected_cells_from_edge = [(0, 1), (0, 2), (0,)]
        edges = [(1, 4), (3, 4), (0, 3)]
        for i in range(0, len(edges)):
            self.assertEqual(expected_cells_from_edge[i], xuquad.edge_adjacent_cells(edges[i]))

    def test_point_adjacent_points_locations(self):
        """Test point_adjacent_points and point_adjacent_locations."""
        #     0-----1-----2
        #     |  0  |  1  |
        #     3-----4-----5
        #     |  2  |  3  |
        ...
        attached_idxs = grid.point_adjacent_points(0)
        expected_idxs = (1, 3)
        self.assertEqual(expected_idxs, attached_idxs)
        attached_idxs = grid.point_adjacent_points(3)
        expected_idxs = (0, 4, 6)
        self.assertEqual(expected_idxs, attached_idxs)
        attached_idxs = grid.point_adjacent_points(4)
        expected_idxs = (1, 3, 5, 7)
        self.assertEqual(expected_idxs, attached_idxs)

        attached_points = grid.point_adjacent_locations(0)
        expected_points = np.array(((10, 10, 0), (0, 0, 0)))
        np.testing.assert_array_equal(expected_points, attached_points)
        attached_points = grid.point_adjacent_locations(3)
        expected_points = ((0, 10, 0), (10, 0, 0), (0, -10, 0))
        np.testing.assert_array_equal(expected_points, attached_points)
        attached_points = grid.point_adjacent_locations(4)
    ...
    def test_cell_edges(self):
        ...
        edges = xuquad.cell_edges(0)
        self.assertEqual(expected_edges, edges)

    def test_cell3d_face_count(self):
        xu2d = self.get_2d_linear_ugrid()
        self.assertEqual(-1, xu2d.cell3d_face_count(-1))
        for i in range(0, xu2d.cell_count()):
            self.assertEqual(0, xu2d.cell3d_face_count(i))
        self.assertEqual(-1, xu2d.cell3d_face_count(xu2d.cell_count()))

        xu3d = self.get_3d_linear_ugrid()

        self.assertEqual(-1, xu3d.cell3d_face_count(-1))
        self.assertEqual(-1, xu3d.cell3d_face_count(6))
        self.assertEqual(4, xu3d.cell3d_face_count(0))
        self.assertEqual(6, xu3d.cell3d_face_count(1))
        self.assertEqual(6, xu3d.cell3d_face_count(2))
        self.assertEqual(6, xu3d.cell3d_face_count(3))
        self.assertEqual(5, xu3d.cell3d_face_count(4))
        self.assertEqual(5, xu3d.cell3d_face_count(5))

    def test_cell3d_face_point_count(self):
        """Test getting the number of face points for a cell face."""
        xu2d = self.get_2d_linear_ugrid()
        # test 1D and 2D cells - should return 0 for valid cell index
        self.assertEqual(-1, xu2d.cell3d_face_point_count(-1, 0))
        self.assertEqual(0, xu2d.cell3d_face_point_count(1, 0))
        self.assertEqual(-1, xu2d.cell3d_face_point_count(xu2d.cell_count(), 0))

        xu3d = self.get_3d_linear_ugrid()

        self.assertEqual(-1, xu3d.cell3d_face_point_count(-1, 0))
        self.assertEqual(-1, xu3d.cell3d_face_point_count(6, 0))
        self.assertEqual(4, xu3d.cell3d_face_point_count(1, 3))
        self.assertEqual(4, xu3d.cell3d_face_point_count(3, 2))

    def test_cell3d_face_points(self):
        xu2d = self.get_2d_linear_ugrid()
        self.assertEqual((), xu2d.cell3d_face_points(-1, 0))
        self.assertEqual((), xu2d.cell3d_face_points(0, -1))
        for i in range(0, xu2d.cell_count()):
            self.assertEqual((), xu2d.cell3d_face_points(i, 0))
        self.assertEqual((), xu2d.cell3d_face_points(xu2d.cell_count(), 0))
        self.assertEqual((), xu2d.cell3d_face_points(0, 1))
        ...
        curr_id = 0
        for i in range(0, xu3d.cell_count()):
            for j in range(0, xu3d.cell3d_face_count(i)):
                self.assertEqual(xu3d.cell3d_face_points(i, j), expected_cell_faces[curr_id])
                curr_id += 1
    ...
    def test_get_faces_of_cell(self):
        ...
        curr_id = 0
        for i in range(0, xu3d.cell_count()):
            faces = xu3d.cell3d_faces_points(i)
            for j in range(0, len(faces)):
                self.assertEqual(faces[j], expected_cell_faces[curr_id])
                curr_id += 1

    def test_cell3d_face_adjacent_cell(self):
        xuhex = self.get_hexahedron_ugrid(3, 2, 2, (0, 0, 0))
        expected_neighbor = [-1, 1, -1, -1, -1, -1, 0, -1, -1, -1, -1, -1]
        self.assertEqual(-1, xuhex.cell3d_face_adjacent_cell(-1, 0))
        self.assertEqual(-1, xuhex.cell3d_face_adjacent_cell(0, -1))
        curr_id = 0
        for i in range(0, xuhex.cell_count()):
            for j in range(0, xuhex.cell3d_face_count(i)):
                neighbor_cell = xuhex.cell3d_face_adjacent_cell(i, j)
                self.assertEqual(expected_neighbor[curr_id], neighbor_cell)
                curr_id += 1
        self.assertEqual(-1, xuhex.cell3d_face_adjacent_cell(xuhex.cell_count(), 0))
        self.assertEqual(-1, xuhex.cell3d_face_adjacent_cell(0,xuhex.cell_count()))
