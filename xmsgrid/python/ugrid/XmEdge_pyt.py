# Place holder for XMugrid_utils Tests
import unittest
...
class TestUGridUtilFunctions(unittest.TestCase):
    ...
    def test_cross(self):
        self.assertEqual(ugrid_utils.cross((0, 0, 0), (5, 5, 0), (3, 4, 0)), 5)
        self.assertEqual(ugrid_utils.cross((7, 3, 0), (10, 5, 0), (11, 9, 0)),
            10)
        self.assertEqual(ugrid_utils.cross((4, 5, 0), (3, 8, 0), (6, 2, 0)),
            -3)
    ...
    def test_do_line_segments_cross(self):
        ...
        point3 = (2, 1, 0)
        point4 = (4, 1, 0)
        self.assertEqual(False, ugrid_utils.do_line_segments_cross(point1,
        ...
        point3 = (2, 4, 0)
        point4 = (4, 2, 0)
        self.assertEqual(True, ugrid_utils.do_line_segments_cross(point1,
            point2, point3, point4))
